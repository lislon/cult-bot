...
//         ])
//         expectedTitles(['A', 'B', 'C'], await db.repoCustomEvents.findEventIdsCustomFilter({oblasti: ['theaters.#A', 'theaters.#B'], weekendRange}))
//
//     }, 1000000)
//
...
//         ])
//
//         expectedTitles(['A', 'B', 'C'], await db.repoCustomEvents.findEventIdsCustomFilter({oblasti: [], weekendRange}))
//     }, 1000000)
//
...
//         ])
//
//          expectedTitles(['A', 'B'], await db.repoCustomEvents.findEventIdsCustomFilter({cennosti: ['#ЗОЖ', '#комфорт'], weekendRange}))
//     }, 1000000)
//
//
...
//         ])
//
//         expectedTitles(['A', 'B'], await db.repoCustomEvents.findEventIdsCustomFilter({weekendRange}))
//     }, 1000000)
//
...
//         ])
//
//         expectedTitles(['B'], await db.repoCustomEvents.findEventIdsCustomFilter({weekendRange}))
//     }, 1000000)
//
...
//         ])
//
//         expectedTitles(['B'], await db.repoCustomEvents.findEventIdsCustomFilter({format: 'outdoor', weekendRange}))
//         expectedTitles(['A'], await db.repoCustomEvents.findEventIdsCustomFilter({format: 'online', weekendRange}))
//         expectedTitles(['A', 'B'], await db.repoCustomEvents.findEventIdsCustomFilter({weekendRange}))
//     }, 1000000)
//
...
//
//         expectedTitles(['A12', 'A13'], await db.repoCustomEvents.findEventIdsCustomFilter({weekendRange: weekendAlreadyStartedRange, timeIntervals: [
...
//         ])
//         expectedTitles(['B', 'C'], await db.repoCustomEvents.findEventIdsCustomFilter({
...
//         await expectedTitles(['D16', 'D12'], await db.repoCustomEvents.findEventIdsCustomFilter({weekendRange, cennosti: ['#сдетьми16+']}))
//     }, 1000000)
//
//     test('Если выбран 12+, то ищем 12+ и 6+', async () => {
//         expectedTitles(['D12', 'D6'], await db.repoCustomEvents.findEventIdsCustomFilter({weekendRange, cennosti: ['#сдетьми12+']}))
//     }, 1000000)
//
//     test('Если выбран 6+, то ищем 6+ и 0+', async () => {
//         expectedTitles(['D6', 'D0'], await db.repoCustomEvents.findEventIdsCustomFilter({weekendRange, cennosti: ['#сдетьми6+']}))
//     }, 1000000)
//
//     test('Если выбран 0+, то ищем только 0+', async () => {
//         expectedTitles(['D0'], await db.repoCustomEvents.findEventIdsCustomFilter({weekendRange, cennosti: ['#сдетьми0+']}))
//     }, 1000000)
// })
//
...
//
//     test('Sorting', async () => {
//         const events = await db.repoCustomEvents.findEventIdsCustomFilter({weekendRange, limit: 100})
//         expect((events).map(t => t.title)).toEqual(goodOrder.map(t => t.title))
//     }, 1000000)
//
//     test('Paging', async () => {
//         const events = await db.repoCustomEvents.findEventIdsCustomFilter({weekendRange, limit: 3, offset: 1})
