...
console.log('test1: ' + moment('2020-01-01 15:00').tz('Europe/Moscow').locale('en').toISOString())
console.log('test2: ' + moment('2020-01-01 15:00').tz('Europe/Moscow', true).locale('en').toISOString())
console.log('test3: ' + moment('2020-01-01 15:00').locale('en').format('HH:mm'))
console.log('test4: ' + moment('2020-01-01 15:00').locale('en').toISOString())
