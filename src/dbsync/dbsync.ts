import { annotateCell, authToExcel, CellColor, clearFormat, colorCell } from './googlesheets'
...
export async function parseAndValidateGoogleSpreadsheets() {
    const validationErrors: SpreadSheetValidationError[] = []
    logger.debug('Connection to excel...')
    ...
    return {validationErrors, rows, excelUpdater}
}
