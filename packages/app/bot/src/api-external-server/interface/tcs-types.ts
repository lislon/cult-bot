...
export type TcsErrorCode = keyof typeof ERROR_CODES

export interface TcsPaymentNotification {
    TerminalKey: string
    OrderId: string
    Success: boolean
    Status: TcsPaymentStatus
    PaymentId: number
    ErrorCode: TcsErrorCode
    Amount: number
    CardId: number
    Pan: string,
    ExpDate: string
