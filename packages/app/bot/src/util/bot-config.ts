...
export class BotConfig {
    ...
    public BILLING_TINKOFF_PASSWORD: string
    public BILLING_TINKOFF_PASSWORD_ENABLED: boolean
    ...
    public FEATURE_BILLING: boolean
    ...
    public setFromKeyValue(envVars: any) {
        ...
        boolean('BOT_ENABLED', true)
        boolean('SITE_ENABLED', true)
        ...
        boolean('BILLING_TINKOFF_PASSWORD_ENABLED', true)
        string('BILLING_TINKOFF_PASSWORD')
        string('SITE_URL', 'http://ssl.bandisoft.com:3000')
