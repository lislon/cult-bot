...
describe('Event Matching', () => {
    ...
    test('Event can be matched', async () => {
        ...
        await syncEventsDb4Test([
            getMockEvent({extId: 'A', title: 'Event One', category: 'theaters', eventTime, tag_level_1: ['#A', '#B', '#C']}),
            getMockEvent({extId: 'B', title: 'Event Two', category: 'theaters', eventTime, tag_level_1: ['#A', '#B', '#C']}),
        ])
